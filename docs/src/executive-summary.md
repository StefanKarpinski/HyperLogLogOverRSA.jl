...
2. **The server can’t smuggle in a fingerprint.** A maliciously constructed RSA modulus *could* secretly tag clients, so the server must publish a certificate proving its modulus is “fingerprint-free.” Clients verify this certificate before using a ring. (Proven in [Malicious servers](09-proof-of-anonymity.md#Malicious-servers).)
...
If you want to dig into the details: HyperLogLog and resource class sharding are covered in [Anonymously Counting Users](01-counting-users.md), and the two proofs are in [Proof of Anonymity](09-proof-of-anonymity.md) (anonymity) and [Malicious servers](09-proof-of-anonymity.md#Malicious-servers) (fingerprint-freedom).
