...
$(document).ready(function() {
  ...
  "macros": {
    ...
    "\\Z": "\\mathbb{Z}",
    "\\and": "\\,\\land\\,",
    "\\bitlen": "\\operatorname{bitlen}",
    "\\bra": "\\left[#1\\right]",
    "\\ceil": "\\left\\lceil #1 \\right\\rceil",
    "\\cld": "\\operatorname{cld}",
    "\\cldmod": "\\operatorname{cldmod}",
    "\\divides": "\\mid",
    "\\eps": "\\operatorname{eps}",
    "\\fld": "\\operatorname{fld}",
    "\\fldmod": "\\operatorname{fldmod}",
    "\\float": "\\operatorname{float}",
    "\\floor": "\\left\\lfloor #1 \\right\\rfloor",
    "\\fmod": "\\operatorname{mod}",
    "\\fr": "\\operatorname{frac}",
    "\\gen": "\\left\\langle #1 \\right\\rangle",
    "\\half": "\\tfrac{1}{2}",
    "\\hash": "\\mathsf{H}",
    "\\hll": "\\mathcal{H}",
    "\\img": "\\operatorname{img}",
    "\\inter": "\\,\\cap\\,",
    "\\invmod": "\\operatorname{invmod}",
    "\\lcm": "\\operatorname{lcm}",
    "\\lz": "\\operatorname{lz}",
    "\\minmax": "\\operatorname{minmax}",
    "\\nfrac": "#1/#2",
    "\\norm": "\\left\\lvert #1 \\right\\rvert",
    "\\or": "\\,\\lor\\,",
    "\\ord": "\\operatorname{ord}",
    "\\qq": "\\qquad",
    "\\round": "\\operatorname{round}(#1)",
